class Terminal{
  constructor(id, directoryPointerId){
    ...
    console.log('this.terminalWindow',this.terminalWindow)
  ...
  async gotoPage(path){
    ...
    .then(markdownContent => {
      // Process the markdown content here
      // const mdBlock = document.getElementById('page-view')
      // mdBlock.innerHTML = markdownContent
      console.log(markdownContent)
      this.output(`<md-block id="page-view">${markdownContent}</md-block>`)
    })
    .catch(error => {
